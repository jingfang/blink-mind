...
var ViewPortViewer = /** @class */ (function (_super) {
    ...
    ViewPortViewer.prototype.render = function () {
        ...
        var controller = props.controller;
        var zoomFactor = controller.run('getZoomFactor', props);
        return (createElement(ViewerRoot, null,
...
function renderDrawer(props) {
    ...
    if (model.focusMode === FocusMode.EDITING_DESC) {
        ...
        var descEditor = controller.run('renderTopicDescEditor', props);
        return (createElement(Drawer, { title: "Edit Notes", icon: Icon('note'), isOpen: true, hasBackdrop: true, backdropProps: { onMouseDown: cancelEvent }, isCloseButtonShown: false, onClose: onDescEditorClose, size: "70%" },
    ...
    Diagram.prototype.renderHotkeys = function () {
        ...
        if (model.focusMode === FocusMode.NORMAL ||
            ...
            hotKeys.forEach(function (v, k) {
                children_1.push(createElement(Hotkey, __assign({ key: k }, v, { global: true })));
            });
...
export { BaseWidget, Btn, CloseIcon, Diagram, DragScrollWidget, EventKey, Flex, Icon, IconBg, IconName, Margin, RefKey, SaveRef, ShowMenuIcon, Title, TopicBlockIcon, cancelEvent, center, centerPointX, centerPointY, centerX, centerY, collapseRefKey, contentRefKey, getLinkKey, getRelativeRect, getRelativeVector, iconClassName, linksRefKey, linksSvgRefKey, topicRefKey, topicWidgetRefKey };
