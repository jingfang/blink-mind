...
var TopicContentEditor = /** @class */ (function (_super) {
    ...
    TopicContentEditor.prototype.onClickOutSide = function (e) {
        ...
        controller.run('operation', __assign(__assign({}, this.props), { opType: OpType.SET_TOPIC_CONTENT, data: this.state.content }));
        controller.run('operation', __assign(__assign({}, this.props), { opType: OpType.FOCUS_TOPIC, focusMode: FocusMode.NORMAL }));
    };
