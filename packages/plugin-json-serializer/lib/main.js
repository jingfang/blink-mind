...
function JsonSerializerPlugin() {
    return {
        ...
        deserializeModel: function (props) {
            ...
            var rootTopicKey = obj.rootTopicKey, topics = obj.topics, config = obj.config, version = obj.version;
            var model = new core.Model();
            model = model.merge({
                rootTopicKey: rootTopicKey,
                editorRootTopicKey: rootTopicKey,
                config: controller.run('deserializeConfig', __assign(__assign({}, props), { obj: config, version: version })),
                topics: controller.run('deserializeTopics', __assign(__assign({}, props), { obj: topics, version: version })),
